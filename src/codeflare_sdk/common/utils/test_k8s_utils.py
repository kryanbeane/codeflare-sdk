...
class TestGetCurrentNamespace:
    ...
    def test_get_current_namespace_incluster_file_read_error(self):
        ...
        mock_print.assert_any_call("Unable to find current workspace")
        mock_print.assert_any_call("Trying to gather workspace from current context")
    ...
    def test_get_current_namespace_kubeconfig_success(self):
        ...
        assert result == "test-namespace"
        mock_print.assert_called_with("Trying to gather workspace from current context")
